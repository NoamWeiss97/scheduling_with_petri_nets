...
class RcpspBase:
    ...
    def _calculate_early_time(self, activity, visited):  # calculate activitiy's earlt start+finish
    ...
    def calculate_critical_path(self):
        ...
        return cpm_duration, cp  # note: returns the cpm duration and A critical path, might be others
